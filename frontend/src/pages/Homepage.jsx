...
import herophoto from "../photos/herophoto.jpg";
...
function App() {
  ...
  //     .then(res => setMsg(res.data.nutritionDetails))
          ...
          <div className="herosection">
            <div className="left-section">
              <div className="herosection-title">
                Your Health, Your Plate, Your Way
              </div>
              <div className="herosection-subtitle">
                Build a custom meal plan tailored to your goals — with foods you
                actually love. Simple, smart, and sustainable — because healthy
                living should feel natural, not forced.
              </div>
