...
import herophoto from './photos/photo-main.jpg'
        ...
        <div className="main-body">
            ...
            <div className="content">
              <div className="hero-main">
                <img src = {herophoto} alt = "food" width = "100%" style={{position: 'relative', top: '0', left: '0'}} />
                <div className="title-main">Welcome, User<br />Choose Your Option!</div>
              </div>

              <div className = "container-main">
                <Card title = "Your Meals" image = "https://freesvg.org/img/mealplate.png" description = "Track your nutrition, plan healthy meals, and maintain a balanced diet with personalized recommendations." buttontitle = "Log Meal" link = "/dietplan"></Card>
